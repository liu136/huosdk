    ...
    if (window.getComputedStyle) {
        ...
        curCSS = function (elem, name, computed) {
            ...
            if (computed) {
                ...
                // reliably pixels this is against the CSSOM draft spec: http://dev.w3.org/csswg/cssom/#resolved-values
...
// Attach a bunch of functions for handling common AJAX events
    ...
    jQuery.fn.extend({
        ...
        position: function () {
            ...
            // fixed elements are offset from window (parentOffset = {top:0, left: 0}, because it is its only offset
            // parent
            ...
            jQuery.fn[funcName] = function (margin, value) {
                ...
                return access(this, function (elem, type, value) {
                    ...
                    if (elem.nodeType === 9) {
                        ...
                        // greatest unfortunately, this causes bug #3838 in IE6/8 only, but there is currently no good,
                        // small way to fix it.
                        return Math.max(
