...
yxspa.api_prefix           = "/mapi.php/";
yxspa.image_prefix         = "/upload/logo/";
yxspa.api_url              = yxspa.api_prefix + "/mobile/index/";
yxspa.pay_url              = "/mobile.php/" + "Pay/preorder";	// 支付地址
yxspa.login                = false;
yxspa.user                 = {
    "mem_id"    : "",
    "session_id": ""
...
var current_search_keyword = "请输入搜索内容";

yxspa.api.regNormal            = yxspa.api_url + "regNormal";
yxspa.api.getCaptchaImg        = yxspa.api_url + "getCaptchaImg";
yxspa.api.getAppDetailInfo     = yxspa.api_url + "getAppDetailInfo";
yxspa.api.getIosAppPostDetail  = yxspa.api_url + "getIosAppPostDetail";
yxspa.api.getIosAppPosts       = yxspa.api_url + "getIosAppPosts";
yxspa.api.getSlides            = yxspa.api_url + "getSlides";
yxspa.api.getNewApps           = yxspa.api_url + "newApps";
yxspa.api.getHotApps           = yxspa.api_url + "rankHotApps";
yxspa.api.getGYApps            = yxspa.api_url + "GetGYApps";
yxspa.api.getKeyApps           = yxspa.api_url + "keyApps";
yxspa.api.login                = yxspa.api_url + "checkLogin";
yxspa.api.cates                = yxspa.api_url + "cates";
yxspa.api.rankApps             = yxspa.api_url + "rankApps";
yxspa.api.rankNewApps          = yxspa.api_url + "rankNewApps";
yxspa.api.rankHotApps          = yxspa.api_url + "rankHotApps";
yxspa.api.onlineNewApps        = yxspa.api_url + "onlineNewApps";
yxspa.api.onlineHotApps        = yxspa.api_url + "onlineHotApps";
yxspa.api.cateApps             = yxspa.api_url + "cateApps";
yxspa.api.cateNewApps          = yxspa.api_url + "cateNewApps";
yxspa.api.cateHotApps          = yxspa.api_url + "cateHotApps";
yxspa.api.search               = yxspa.api_url + "search";
yxspa.api.reg                  = yxspa.api_url + "reg";
yxspa.api.sendPhoneCode        = yxspa.api_url + "sendPhoneCode";
yxspa.api.findpwd              = yxspa.api_url + "findpwd";
yxspa.api.sendPhoneCodeToExist = yxspa.api_url + "sendPhoneCodeToExist";
yxspa.api.gift                 = yxspa.api_url + "gift";
yxspa.api.giftDetail           = yxspa.api_url + "giftDetail";
yxspa.api.getGiftCode          = yxspa.api_url + "getGiftCode";
yxspa.api.myGiftCodes          = yxspa.api_url + "myGiftCodes";
yxspa.api.getCompanyAbout      = yxspa.api_url + "getCompanyAbout";
yxspa.api.getContactInfo       = yxspa.api_url + "getContactInfo";
yxspa.api.loginThird           = yxspa.api_url + "loginThird";
yxspa.api.loginState           = yxspa.api_url + "loginState";
yxspa.api.logout               = yxspa.api_url + "logout";
yxspa.api.getServerList        = yxspa.api_url + "getServerList";
yxspa.api.getAbs               = yxspa.api_url + "get_abs";
yxspa.api.getappinfo           = yxspa.api_url + "getAppInfo";
yxspa.api.GetLikeApps          = yxspa.api_url + "GetLikeApps";
yxspa.api.gamedown             = yxspa.api_url + "setgamedown";
...
var yxapp = angular.module('app', ['ngRoute', 'ngclipboard']);
...
yxapp.controller("moduleCardCodeListController", function ($scope, $route, $http) {
    ...
    $scope.list1 = [
        ...
        {"name": "传奇copystrig世界", "code": "fghjfgjh", "icon": "./static/img/icon/1.png"},
    ...
    $scope.onSuccess = function (e) {
        ...
        e.clearSelection();
        yxshare.ui.alert("复制成功");
    };
    $scope.onError   = function (e) {
        yxshare.ui.alert("复制失败,请选择礼包码手动复制");
    }
...
yxapp.controller("moduleAppRankController", function ($scope, $route, $http) {
    ...
    $scope.loadNew  = function () {
        $http.get(yxspa.api.rankApps + "/type/" + type + "/page/" + $scope.page_new).success(function (res) {
            if (res.length === 0) {
        ...
        /*$http.get(yxspa.api.rankNewApps + "/type/" + type +  "/page/" + $scope.page_new).success(function (res) {
         if (res.length === 0) {
         $("#loadMoreText_new").text("没有更多了");
         return;
         }
    ...
    /*$scope.hotlist  = [];
     ...
     $http.get(yxspa.api.rankHotApps + "/type/" + type +  "/page/" + $scope.page_hot).success(function (res) {
     if (res.length === 0) {
...
yxapp.controller("moduleNaviTabsController", function ($scope, $route) {
    $scope.list      = [
        ...
        {"icon": "./static/img/asset/new_game2.png", "name": "新游", "url": "#/rank/1"},
...
//    console.log("cate detail apps "+id);
    ...
    $scope.load = function () {
        $http.get(yxspa.api.cateApps + "/cateid/" + id + "/page/" + $scope.page_new).success(function (res) {
            if (res.length === 0) {
                $("#loadMoreText_new").text("没有更多了");
                return;
            }
...
yxapp.controller("moduleNewRecommendAppController", function ($scope, $http) {
    ...
    if (yxspa.dev_mode) {
        ...
        $scope.goto_more = function (type) {
            location.href = "#/rank/" + type;
        };
...
yxapp.directive('moduleHotApp', function () {
    return {
        templateUrl: 'modules/HotApp.html',
        replace    : true
...
yxapp.controller("moduleLikeAppController", function ($scope, $http) {
    $scope.image_prefix = yxspa.image_prefix;
    $scope.page         = 1;
    $scope.list         = [];
    $scope.typelist     = new Array();
    ...
    console.log(yxspa.api.GetLikeApps);
    $scope.load = function () {
        $http.get(yxspa.api.GetLikeApps + "/page/" + $scope.page).success(function (res) {
            if (res.length === 0) {
                $("#loadMoreText").text("没有更多了");
            } else {
                $scope.list = $scope.list.concat(res);
...
//            };
        ...
        $scope.downgame = function (id) {
            $http.get(yxspa.api.gamedown+"?appid=" + id).success(function (res) {
                if (res.state === "true") {
...
yxapp.controller("moduleBottomTabsController", function ($scope, $route) {
    ...
    var url        = ["home", "rank/0", "gift", "account"];
    $scope.current = 0;
...
//新游广告图
yxapp.controller("moduleImageBlock3Controller", function ($scope, $route, $http) {
    $http.get(yxspa.api.getAbs + "/type/3").success(function (res) {
        $scope.img       = res.pic_url;
        $scope.target_id = res.target_id;
    });
    $scope.goto2 = function (appid) {
...
//热门广告图
yxapp.controller("moduleImageBlock4Controller", function ($scope, $route, $http) {
    $http.get(yxspa.api.getAbs + "/type/4").success(function (res) {
        $scope.img       = res.pic_url;
        $scope.target_id = res.target_id;
    });
    $scope.goto2 = function (appid) {
