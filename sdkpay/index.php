...
//项目路径，不可更改
define('APP_PATH', SITE_PATH . 'app/sdkpay/');
//项目相对路径，不可更改
define('DAMAITHINK_PATH',   SITE_PATH.'thinkphp/');
//
define('SPAPP',   '../app/sdkpay/');
//项目资源目录，不可更改
define('SPSTATIC',   SITE_PATH.'sdkpay/public/');
//定义缓存存放路径
define("RUNTIME_PATH", SITE_PATH . "data/runtime/sdkpay/");
//静态缓存目录
define("HTML_PATH", SITE_PATH . "data/runtime/sdkpay/Html/");
