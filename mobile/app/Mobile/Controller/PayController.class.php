...
class PayController extends PaybaseController {
    ...
    private function merge_zfb_config() {
        ...
        return $alipay_config_fix = array(
            ...
            'return_url'          => MOBILESITE."/mobile/index.html", //页面跳转同步通知页面路径
            'show_url'            => MOBILESITE."/mobile/index.html", //商品展示地址
            'subject'             => '充值平台币', // 订单名称
            'body'                => "游戏充值", // 订单描述
            'it_b_pay'            => '15d', // 超时时间
            'extern_token'        => '', // 钱包token
            'input_charset'       => 'utf-8', // 字符串类型
            'private_key_path'    => SITE_PATH.'conf/pay/alipay/key/rsa_private_key.pem', //商户的私钥（后缀是.pen）文件相对路径
            'ali_public_key_path' => SITE_PATH.'conf/pay/alipay/key/alipay_public_key.pem', //支付宝公钥（后缀是.pen）文件相对路径
