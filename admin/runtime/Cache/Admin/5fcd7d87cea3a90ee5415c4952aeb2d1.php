...
<head >
    ...
    <link rel="stylesheet" href="/public/simpleboot/themes/huosdk/simplebootadminindex.min.css?" >
    <!--[if lte IE 8]>
    ...
    <?php function getsubmenu($submenus){ foreach((array)$submenus as $menu){ ?>
    <li class="top_menu_li" onclick="show_side(this,'<?php echo ($menu["id"]); ?>');" >
    ...
    <div class="side_menu side_menu_<?php echo ($menu["id"]); ?>" style="display:none;" >
    ...
    <li class="open" >
        ...
        <a href="javascript:openapp('<?php echo ($menu["url"]); ?>','<?php echo ($menu["id"]); ?>','<?php echo ($menu_name); ?>',true);" >
            ...
            <i class="fa fa-<?php echo ((isset($menu["icon"]) && ($menu["icon"] !== ""))?($menu["icon"]):'caret-right'); ?>" ></i >
								<span class="menu-text" >
									<?php echo ($menu_name); ?>
								</span >
        </a >
...
<div id="right_tools_wrapper" >
    ...
    <span id="refresh_wrapper" title="<?php echo L('REFRESH_CURRENT_PAGE');?>" ><i
    ...
    <div class="navbar-inner" >
        <div class="container-fluid" >
            ...
            <div class="pull-left nav_shortcuts" >
                ...
                <?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache')): ?><a class="btn btn-small btn-danger" style="float:left;"
                       href="javascript:openapp('<?php echo U('admin/setting/clearcache');?>','index_clearcache','<?php echo L('ADMIN_SETTING_CLEARCACHE');?>');"
            ...
            <ul class="nav simplewind-nav pull-right" style="display:inline;" >
                <li class="light-blue" style="display:inline;" >
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle" >
                        <!--                                                        <?php if($admin['avatar']): ?><img class="nav-user-photo" width="30" height="30" src="<?php echo sp_get_user_avatar_url($admin['avatar']);?>" alt="<?php echo ($admin["user_login"]); ?>">
                                                    <?php else: ?>
                                                        <img class="nav-user-photo" width="30" height="30" src="/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>-->
...
<div class="main-container container-fluid" >
    ...
    <div class="sidebar" id="sidebar" style="background-color:#F4F4F4 !important" >
    ...
    <div class="main-content" >
        <div class="breadcrumbs" id="breadcrumbs" >
            ...
            <span class="close_all_tast_btn fa fa-close"
                  style="margin-left:10px;font-size:12px;color:#999999;cursor:pointer;" title="关闭全部" >关闭全部</span >
        </div >

        <div class="page-content" id="content" >
            <iframe src="<?php echo U('Main/index');?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0"
...
<script >
    ...
    $(document).ready(function () {
        $(".top_menu_li").first().click();

    });
    $(".close_all_tast_btn").click(function () {
        $(".macro-component-tabclose-icon").click();
    });

    function bind_submenu_click() {
        $("#nav_wraper").delegate(".submenu>li", "click", function () {
//                $(this).children("a").addClass("active_submenu_li");

//                $(this).siblings("li").children("a").css("color","#fff");
            $(this).parent().parent().parent().find("a").css("background-color", "#E7E7E7");
            $(this).find("a").css({
    ...
    function show_side(e, menuid) {
//            alert('hi');
//            return;
        $(".top_menu_li").children("a").removeClass("active");
//alert(this);
        $(e).children("a").addClass("active");
        var content = $(".side_menu_" + menuid).html();
//            alert(content);
        $(".nav-list").html(content);
