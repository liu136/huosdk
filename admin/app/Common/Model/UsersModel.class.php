...
class UsersModel extends CommonModel {
    protected $_validate
        = array(
            ...
            array('user_login', 'checkuser', '账号格式不正确！', 0, 'callback', CommonModel::MODEL_BOTH),
            // 验证user_login字段格式是否正确
    ...
    protected $_auto
        = array(
            ...
            array('user_pass', 'mPassword', CommonModel::MODEL_INSERT, 'callback'),
            array('pay_pwd', 'mPaypwd', CommonModel::MODEL_INSERT, 'callback'),
        );
