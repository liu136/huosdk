...
<div >
    ...
    <form method="post" name="theform" action="<{$WEBSITE}>?m=Versions&a=modifyApp" >
        <div >
            ...
            <span >请填写路径 ： </span ><input type="text" name="url" value="<{$data.url}>" size='60' ><span
                    style="color:#00F" >注意带上前缀http://,如<{$DOMAINHOST}></span >
            <br >
                ...
                <tr >
                    ...
                    <td align="" style="font-family: arial" width="95%" >
                        <textarea id="content" name="content"
                                  style="width:710px;height:100px;" ><{$data.content}></textarea >
                    </td >
                </tr >
            </table >
        </div >
