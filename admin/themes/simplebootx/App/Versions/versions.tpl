...
<head >
    ...
    <script type="text/javascript" charset="utf-8"
            src="<{$DOMAINHOST}>/plus/ueditor1_4_3/ueditor.all.min.js" ></script >
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8"
            src="<{$DOMAINHOST}>/plus/ueditor1_4_3/lang/zh-cn/zh-cn.js" ></script >
    ...
    <div id="dlg" class="easyui-dialog" style="width:1170px;height:520px;padding:10px 20px"
        ...
        <form id="fm" method="post" enctype="multipart/form-data" novalidate >
            <table >
                ...
                <tr >
                    <td >版本:</td >
                    <td ><input name="versions" type="text" style="width: 130px" ></input ><font color="red" >*</font >
                    </td >
                </tr >
                <tr >
                    <td >路径:</td >
                ...
                <tr >
                    <td >大小:</td >
                    <td ><input name="size" type="text" style="width: 130px" ></input ><font color="red" >*</font >
                    </td >
                </tr >
