						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="index.html" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>欢迎光临,</small>
									<?php echo ((isset($clientuser["user_nicename"]) && ($clientuser["user_nicename"] !== ""))?($clientuser["user_nicename"]):$clientuser[user_login]); ?>
								</span>
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/user/userinfo')): ?><li>
										<a class="J_menuItem" href="<?php echo U('user/userinfo');?>">
											<i class="icon-user"></i>
											个人资料
										</a>
									</li><?php endif; ?>
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<a href="<?php echo ($menu["url"]); ?>" realhref="<?php echo ($menu["url"]); ?>" class="J_menuItem">
							...
							<div class="col-xs-12">
								...
								<div class="page-content-inner">
									 <div class="row J_mainContent" id="content-main">
										 <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo U('Main/index');?>" frameborder="0" data-id="index_v1.html" seamless style="min-height:980px"></iframe>
									 </div>
								</div>
...
<![endif]-->
		...
		<script type="text/javascript" src="/public/h/js/contabs2.min.js"></script>
