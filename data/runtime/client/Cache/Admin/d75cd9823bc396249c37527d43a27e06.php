...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
			...
			<li><a href="<?php echo U('Gift/addGift');?>" target="_self">添加礼包</a></li>
		</ul>
     <div class="ibox-content">
         <form role="form" class="form-inline" method="post" action="<?php echo U('Gift/giftList');?>">     
		   <div class="form-group">
                 <label class="font-noraml">礼包名：</label>
                 <input type="text" name="title" value="" placeholder="请输入礼包名..." class="form-control">
           </div>
			...
			<div class="ibox-content">
               <table class="table table-striped table-bordered table-hover dataTables-example" style="margin-bottom:5px">
				...
				<?php if(is_array($giftlist)): foreach($giftlist as $key=>$vo): ?><tr>
					...
					<td><?php echo date('Y年m月d日  H:i',$vo['starttime']);?></td>
					<td><?php echo date('Y年m月d日  H:i',$vo['endtime']);?></td>
					<td>
					    <a href="<?php echo U('Gift/editGift',array('id'=>$vo['id']));?>">修改</a> 
						<a href="<?php echo U('Gift/delGift',array('id'=>$vo['id']));?>" class="J_ajax_add">删除</a></td>
