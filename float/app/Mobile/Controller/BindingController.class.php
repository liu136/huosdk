...
class BindingController extends MobilebaseController {
    ...
    public function verifycode() {
        ...
        /*Added by wuyonghong BEGIN 2017-06-20 ISSUES:2738  添加手机号登陆 */
        $_model = M('members');
        $_mem_data = $_model->where(array('id' => $userdata))->find();
        if (!empty($_mem_data['bindmobile'])) {
            $userdata['bindmobile'] = $setmobile;
        }
