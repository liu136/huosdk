...
<nav >
    <ul >
        <li ><a href="<?php echo U('Mobile/Gift/index', array('show'=>'list'));?>" >礼包列表</a ></li >
        <li class="active" ><a href="<?php echo U('Mobile/Gift/index', array('show'=>'mygift'));?>" >我的礼包</a ></li >
    </ul >
</nav >
<div class="libao_box" >
    <ul class="box copy" >
                ...
                <div class="left" >
                    <a href="<?php echo U('Mobile/Gift/detail',array('giftid'=>$vo['giftid']));?>" >
                        ...
                        <div class="text" >
                            ...
                            <p ><?php echo ($vo["code"]); ?></p >
                            <!-- <span class="geted">已领取</span> -->
                        </div >
                    </a >
                </div >
                <div class="right" >
                    <a href="#" class="btn copyGift" data-clipboard-text="<?php echo ($vo["code"]); ?>" >复制</a >
                </div >
