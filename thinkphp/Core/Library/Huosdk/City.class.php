...
class City {
    ...
    public function get_cities_of_province($p) {
        $all_city = array();
        foreach ($this->cities as $key => $province) {
            if ($province['province_name'] == $p) {
                $all_city = $this->cities[$key]['city'];
                break;
            }
        }
        $clean_city = array();
        foreach ($all_city as $key => $value) {
            $clean_city[] = $all_city[$key]['city_name'];
        }
        return $clean_city;
    }
