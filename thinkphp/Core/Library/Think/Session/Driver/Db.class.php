...
class Db {
    ...
    public function read($sessID) {
        ...
        $res = mysql_query(
            'SELECT session_data AS data FROM '.$this->sessionTable
            ." WHERE session_id = '$sessID'   AND session_expire >".time(), $hander
        );
        if ($res) {
    ...
    public function write($sessID, $sessData) {
        ...
        mysql_query(
            ...
            ." (  session_id, session_expire, session_data)  VALUES( '$sessID', '$expire',  '$sessData')", $hander
        );
