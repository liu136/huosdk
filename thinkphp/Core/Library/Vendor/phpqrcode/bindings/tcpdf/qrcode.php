    ...
    class QRcode {
        ...
        protected function encodeModeNum($inputitem, $version) {
            ...
            $inputitem['bstream'] = $this->appendNum(
                $inputitem['bstream'], $this->lengthIndicator(QR_MODE_NM, $version), $inputitem['size']
            );
            for ($i = 0; $i < $words; ++$i) {
        ...
        protected function encodeModeAn($inputitem, $version) {
            ...
            $inputitem['bstream'] = $this->appendNum(
                v, $this->lengthIndicator(QR_MODE_AN, $version), $inputitem['size']
            );
            for ($i = 0; $i < $words; ++$i) {
        ...
        protected function encodeMode8($inputitem, $version) {
            ...
            $inputitem['bstream'] = $this->appendNum(
                $inputitem['bstream'], $this->lengthIndicator(QR_MODE_8B, $version), $inputitem['size']
            );
        ...
        protected function encodeModeKanji($inputitem, $version) {
            ...
            $inputitem['bstream'] = $this->appendNum(
                $inputitem['bstream'], $this->lengthIndicator(QR_MODE_KJ, $version), (int)($inputitem['size'] / 2)
            );
        ...
        protected function encodeBitStream($inputitem, $version) {
            ...
            if ($inputitem['size'] > $words) {
                ...
                $st2 = $this->newInputItem(
                    $inputitem['mode'], $inputitem['size'] - $words, array_slice($inputitem['data'], $words)
                );
