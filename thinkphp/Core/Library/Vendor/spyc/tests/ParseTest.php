...
class ParseTest extends PHPUnit_Framework_TestCase {
    ...
    public function testMergeHashKeys() {
        $Expected = array(
            array('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12,
                                  'repetition' => 1000, 'spotSize' => '1mm')),
            array('step' => array('instrument' => 'Lasik 2000', 'pulseEnergy' => 5.4, 'pulseDuration' => 12,
                                  'repetition' => 1000, 'spotSize' => '2mm')),
        );
    ...
    public function testSeq3() {
        $this->assertEquals(
            array("YAML is so easy to learn.",
    ...
    public function testAnotherSequence() {
        $this->assertEquals(
            array("program" => "Adium", "platform" => "OS X",
    ...
    public function testCrazy() {
        $this->assertEquals(
            array(array("name" => "spartan", "notes" =>
    ...
    public function testNestedNestedInline() {
        $this->assertEquals(
            array("This", array("Is", "Getting", array("Ridiculous", "Guys")),
    ...
    public function testNestedInlineMappings() {
        $this->assertEquals(
            array("name"  => "mark", "age" => "older than chris",
    ...
    public function testEndloop() {
        $this->assertEquals(
            "Does this line in the end indeed make Spyc go to an infinite loop?", $this->yaml['endloop']
        );
    }
    ...
    public function testSwitches() {
        $this->assertEquals(
            array(array('row' => 0, 'col' => 0, 'func' => array('tx' => array(0, 1)))), $this->yaml['switches']
        );
    }
    ...
    public function testMultilines() {
        $this->assertSame(
            array(array('type' => 'SomeItem', 'values' => array('blah', 'blah', 'blah', 'blah'),
                        'ints' => array(2, 54, 12, 2143))), $this->yaml['multiline_items']
        );
    }
