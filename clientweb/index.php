...
//项目路径，不可更改
define('APP_PATH', SITE_PATH . 'app/clientweb/');
//项目相对路径，不可更改
define('DAMAITHINK_PATH',   SITE_PATH.'thinkphp/');
//
define('SPAPP',   '../app/clientweb/');
//项目资源目录，不可更改
define('SPSTATIC',   SITE_PATH.'public/');
//定义缓存存放路径
define("RUNTIME_PATH", SITE_PATH . "data/runtime/clientweb/");
//静态缓存目录
define("HTML_PATH", SITE_PATH . "data/runtime/clientweb/Html/");
