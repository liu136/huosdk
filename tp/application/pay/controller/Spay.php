...
class Spay extends Base {
    ...
    public function returnurl() {
        ...
        if (3 == \think\Session::get('pay_from', 'order')) {
            ...
            $_status = $_de_info['status'];
            $_get_token = Session::get('spay_return_token') ? Session::get('spay_return_token') : Session::get('spay_return_token','think');
            $_return_token = urldecode($_get_token);
            $_return_token .= '&st='.$_status;
        }
