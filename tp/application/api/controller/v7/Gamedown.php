...
class Gamedown extends Base {
    ...
    public function down($downid = 0, $gameid = 0) {
        ...
        $_gd_class = new \huosdk\game\Gamedown();
    ...
    public function geturl() {
        ...
        if (empty($_game_id)) {
            return hs_huosdk_responce('436', '游戏ID错误', null);
        }
        ...
        return hs_huosdk_responce(200,'查询成功',$_rdata,$this->auth_key);
    }
}