...
//         $_rdata['password'] = $this->m_class->authPwd(hs_random(8));
     ...
     */
    function register() {
        $_key_arr = array('app_id', 'client_id', 'from',   'username', 'password','deviceType');
        ...
        $_float_is_show = 1;
        $_rdata['loginType'] = 'account';
        $_rdata["mem_id"]!= '' && $_rdata["mem_id"] != null && $this->SaveLoginData($_rdata,$_data['app_id']);
        return $this->LgReturn($_rdata["mem_id"], $_rdata["cp_user_token"], $_data["app_id"], "login", $_data["deviceType"],  $_rdata['loginType'] );
        
        //return $this->rgReturn($_rdata["mem_id"], $_rdata["cp_user_token"], $_rdata["agentgame"], $_float_is_show,"register");
    }
     ...
     */
    function regMobile() {
        $_key_arr = array('app_id', 'client_id', 'from',  'userua', 'mobile', 'password',
                          'smstype', 'smscode');
        /* 验证手机短信 */
        $this->checkMobile();
        ...
        //return $this->rgReturn($_rdata["mem_id"], $_rdata["cp_user_token"], $_rdata["agentgame"], $_float_is_show,"regMobile");
    }
     ...
     *
     */
    function update_bindmobile() {
       return $this->webbindmobile();
