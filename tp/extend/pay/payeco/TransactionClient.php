 ...
 * 4、订单结果通知签名验证
 */
require_once("ConstantsClient.php");
...
class TransactionClient {
     ...
     */
    static function MerchantOrder(
        $merchantId, $merchOrderId,
     ...
     * @throws Exception    :  E101:通讯失败； E102：签名验证失败；  E103：签名失败；
     */
    static function OrderQuery(
        $merchantId, $merchOrderId, $tradeTime,
     ...
     * @throws Exception    :  E101:通讯失败； E102：签名验证失败；  E103：签名失败；
     */
    static function OrderReverse(
        $merchantId, $merchOrderId, $amount, $tradeTime,
        $priKey, $pubKey, $payecoUrl, Xml $retXml
    ) {
        //交易参数
     ...
     * @throws Exception
     */
    static function bCheckNotifySign(
        $version, $merchantId,
     ...
     * @throws Exception        E101:通讯失败； E102：签名验证失败；  E103：签名失败；
     */
    static function MerchantOrderH5(
        $merchantId, $merchOrderId,
