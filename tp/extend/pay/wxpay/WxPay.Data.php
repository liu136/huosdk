...
class WxPayDataBase {
     ...
     * 生成签名
     *
     * @return String(32) 签名，本函数不覆盖sign成员变量，如要设置签名需要调用SetSign方法赋值
     */
