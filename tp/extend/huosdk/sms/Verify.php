...
class Verify extends Sms {
     ...
     */
    public function __construct($mobile, $smscode, $smstype = 0, $expire_time = 120) {
        $this->mobile = $mobile;
    ...
    public function check() {
        ...
        \think\Log::write($_sms_info,"error");
        /* 查询是否发送过验证码 */
        ...
        if($this->mobile!=Session::get('mobile', 'sms')){
            $_rdata['code'] = '416';
            $_rdata['msg'] = '手机验证不匹配';
            return $_rdata;
        }
