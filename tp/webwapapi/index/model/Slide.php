...
class Slide extends Model {
    ...
    // 获取首页背景图
    public function bgSlide() {
        $cid = $this->getSlideCid('首页背景图', 'indexground', 6);
        return Db::name('slide')->where(array('slide_cid'=>$cid,'slide_status'=>2))->value('slide_pic');
    }

    public function bgUrl() {
        $cid = $this->getSlideCid('首页背景图', 'indexground', 6);
        return Db::name('slide')->where(array('slide_cid'=>$cid,'slide_status'=>2))->value('slide_url');
    }
