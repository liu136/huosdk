...
define('SITE_PATH', substr(dirname(__FILE__), 0, -14)."/");
...
define('LDB_PREFIX', $dbconf['LDB_PREFIX']); //总数据前缀

define('AUTH_DB_NAME', $dbconf['AUTH_DB_NAME']); // 前缀
define('DATA_DB_NAME', $dbconf['DATA_DB_NAME']); // 前缀
define('MNG_DB_NAME', $dbconf['MNG_DB_NAME']); // 前缀

define('AUTHCODE', $dbconf['AUTHCODE']);
define('CIDENTY', $dbconf['CIDENTY']);
define('CLIENTKEY', $dbconf['CLIENTKEY']);
