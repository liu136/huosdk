...
if(file_exists(SITE_PATH."conf/sdkfloat/config.php")){
		$runtime_config=include SITE_PATH."conf/sdkfloat/config.php";
}else{
    $runtime_config=array();
}

if (file_exists(SITE_PATH."conf/sdkfloat/route.php")) {
    $routes = include SITE_PATH.'conf/sdkfloat/route.php';
} else {
    $routes = array();
}
