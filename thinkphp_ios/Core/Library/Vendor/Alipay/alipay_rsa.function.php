...
function rsaSign($prestr) {
    if (empty(C('private_key_path'))) {
        C('private_key_path', '/huosdk/conf/pay/alipay/key/rsa_private_key.pem');
    }
    $config['private_key_path'] = C('private_key_path');
...
function rsaVerify($prestr, $sign) {
    if (empty(C('public_key_path'))) {
        C('public_key_path', '/huosdk/conf/pay/alipay/key/alipay_public_key.pem');
    }
    $config['public_key_path'] = C('public_key_path');
