...
BBBB;
    ...
    public function testParseValidXml() {
        ...
        $this->assertEquals(
            $this->cleanXml($lifecycleConfig->serializeToXml()), $this->cleanXml($this->validLifecycle)
        );
    ...
    public function testParseValidXml2() {
        ...
        $this->assertEquals(
            $this->cleanXml($lifecycleConfig->serializeToXml()), $this->cleanXml($this->validLifecycle2)
        );
